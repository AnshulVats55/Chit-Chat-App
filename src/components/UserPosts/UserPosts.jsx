    ...
    <Grid container className={classes.gridContainerStyles}>
      {userAllPosts.length !== 0 ? (
            ...
            >
              <Box className={classes.userPostContStyles}>
                <img
                  src={post.attachment}
                  alt=""
                  className={classes.userPostStylesOne}
                />
              </Box>
              <Box className={classes.postCaptionCont}>
                <Typography variant="h6" className={classes.postCaption}>
                  {post.body}
                </Typography>
              </Box>
            </Grid>
        ...
        <Box className={classes.noPostsContStyles}>
          <Typography className={classes.noPostsTextMessage}>
            Your posts will appear here...
          </Typography>
          <img src={NoPostSVG} alt="" className={classes.noPostsImage} />
        </Box>
      )}
    </Grid>
  );
