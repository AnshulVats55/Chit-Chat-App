  ...
  return (
    <Grid container className={classes.userProfileInfoGrid}>
      <Grid
        ...
        sm={12}
        xs={12}
        className={classes.userProfileInfoGridItem}
      >
      ...
      <Grid
        ...
        sm={12}
        xs={12}
        className={classes.userSocialInfoCon}
      >
        <Box className={classes.userSocialInfo}>
          ...
          <Box className={classes.followerInfo}>
            <Typography variant="h6" className={classes.socialAnalytics}>
              {userAllPosts.length <= 1
                ? `${userAllPosts.length} Post`
                : `${userAllPosts.length} Posts`}{" "}
            </Typography>

            <Typography variant="h6" className={classes.socialAnalytics}>
              {userSocialInfo.followers
                ? `${userSocialInfo.followers.length} Friends`
                : `0 Friends`}
            </Typography>
          </Box>

          <Typography variant="body1" className={classes.userBio}>
            Spitting fire and weaving words into poetry. Indian Rapper and
            Lyricist, bringing you the beats of the streets.
          </Typography>
        </Box>
      </Grid>
    </Grid>
